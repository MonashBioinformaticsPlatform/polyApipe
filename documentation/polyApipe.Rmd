...
4. **APA Analysis** can then be performed, we recommend using the [weitrix](http://www.bioconductor.org/packages/release/bioc/html/weitrix.html) package.
